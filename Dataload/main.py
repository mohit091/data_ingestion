...
def data_process():
    try:
        ...
        dl.raw_data_load('db','5432','database','username','secret')
        ...
        dc.data_load('db','5432','database','username','secret')
        ...
        dt.data_load('db','5432','database','username','secret')
        ...
        ft.data_load('db','5432','database','username','secret')
        ...
        ftl.data_load('db','5432','database','username','secret')
